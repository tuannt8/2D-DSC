...
#ifdef PROFILE_DSC_DEFORM
void profile::profile_dsc_deform_start()
{
    instance.count++;
    instance.m_start = P_TIME_NOW;
}

void profile::profile_dsc_deform_stop()
{
    p_duration_t t = (P_TIME_NOW - instance.m_start);
    instance.m_total_time += t.count();
}
#endif